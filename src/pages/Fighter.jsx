                ...
                <div className="gallery_part_item">
                  <div className="grid">
                    ...
                    <a
                      ...
                      style={{
                        backgroundImage:
                          'url("img/gallery/gallery_item_1.png")',
                      }}
                    >
                    ...
                    <a
                      ...
                      style={{
                        backgroundImage:
                          'url("img/gallery/gallery_item_2.png")',
                      }}
                    >
                      <div className="single_gallery_item">
                        <div className="single_gallery_item_iner">
                    ...
                    <a
                      ...
                      style={{
                        backgroundImage:
                          'url("img/gallery/gallery_item_3.png")',
                      }}
                    >
                      <div className="single_gallery_item">
                        <div className="single_gallery_item_iner">
                    ...
                    <a
                      ...
                      style={{
                        backgroundImage:
                          'url("img/gallery/gallery_item_5.png")',
                      }}
                    >
                      <div className="single_gallery_item">
                        <div className="single_gallery_item_iner">
                    ...
                    <a
                      ...
                      style={{
                        backgroundImage:
                          'url("img/gallery/gallery_item_7.png")',
                      }}
                    >
                      <div className="single_gallery_item">
                        <div className="single_gallery_item_iner">
                    ...
                    <a
                      ...
                      style={{
                        backgroundImage:
                          'url("img/gallery/gallery_item_6.png")',
                      }}
                    >
                      <div className="single_gallery_item">
                        <div className="single_gallery_item_iner">
                    ...
                    <a
                      ...
                      style={{
                        backgroundImage:
                          'url("img/gallery/gallery_item_4.png")',
                      }}
                    >
                      <div className="single_gallery_item">
                        <div className="single_gallery_item_iner">
